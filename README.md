...
## 📝 Sobre
O ***Pão na Hora*** é uma aplicação criada para facilitar o controle do tempo de preparo do pão feito na panificadora, permitindo que ele esteja pronto exatamente na hora desejada.
